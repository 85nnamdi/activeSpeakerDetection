...
txtvideoSet_train = 'dataset/train_set.txt'
jsonPath = 'dataset/json/'
csv_train ='dataset/csv/train/'
csvDir = 'dataset/csv/test/'
val_folder = "dataset/videos/val/"
train_folder = "dataset/videos/train/"
videos = 'dataset/videos/'

def main():
    # 1 Download videos
    videoFile = VideoData(Base_train_url)
    # videoFile.download(txtvideoSet,val_folder)
    videoFile.download(txtvideoSet_train,train_folder)
    # util = Utilities()
    # rootPath = os.getcwd()
    # # 2 Save video frames
